...
- [Core] Aligned field handling with Spock (instance fields, `@Shared` fields, `lateinit` fields)
- [Core] Added block entry/exit tracking and mock controller lifecycle management
