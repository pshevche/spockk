...
== io.github.pshevche.spockframework

This package contains https://github.com/spockframework/spock/tree/master/spock-specs[Spock's original specifications] migrated to Kotlin and executed with Spockk.
The idea is to ensure that Spockk is compatible with Spock.
The number of this specs will increase as more features are added to Spockk.

== io.github.pshevche.spockk

This package contains specifications that are specific to Spockk (e.g., Kotlin compatibility checks, etc.)
